    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(related_name='apns_devices', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_id', models.TextField(verbose_name='Registration ID')),
                ('device_id', models.TextField(null=True, verbose_name='Device ID', blank=True)),
                ('owner', models.ForeignKey(related_name='gcm_devices', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
